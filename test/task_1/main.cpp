...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // ÑäÏÑ ßá Mesh
        topCircle.Draw(GL_TRIANGLE_FAN);       // Circle ÝæÞ
        topCylinder.Draw(GL_TRIANGLE_STRIP);     // Cylinder ÝæÞ
        topCircle2.Draw(GL_TRIANGLE_FAN);      // Circle ÃÚáì ãä Cylinder
        bottomCircle.Draw(GL_TRIANGLE_FAN);    // Circle ÃÓÝá
        bottomCylinder.Draw(GL_TRIANGLE_STRIP);  // Cylinder ÃÓÝá
